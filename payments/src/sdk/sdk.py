...
from .benefits_enrollment import BenefitsEnrollment
...
class SDK:
    ...
    def _init_sdks(self):
        self.benefits_enrollment = BenefitsEnrollment(self.sdk_configuration)
        self.benefits_service = BenefitsService(self.sdk_configuration)
